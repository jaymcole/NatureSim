...
namespace MonoSimulation.Engine.Cameras
{
    /// <summary>
    ...
    public class Basic3dExampleCamera
    {
        ...
        private void FpsUiControlsLayout(GameTime gameTime)
        {
            ...
            if (mouseLookIsUsed)
            {
                ...
                Vector2 diff = state.Position.ToVector2() - new Vector2((int)graphicsDevice.Viewport.Width / 2, (int)graphicsDevice.Viewport.Height / 2);
                if (diff.X != 0f)
